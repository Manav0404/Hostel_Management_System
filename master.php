                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="<?php echo $base_url.'ui/cost/view.php'?>">Inventory List View</a>
                            </li>
                    ...
                    <li>
                        <a href="#"><i class="fa fa-list-alt fa-fw"></i>Events Board<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="<?php echo $base_url.'ui/notice/create.php'?>">Event Add/List</a>
                            </li>
