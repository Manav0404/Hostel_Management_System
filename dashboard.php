                ...
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-xs-9 text-right">
                            <div class="huge"><?php echo isset($GLOBALS['totals'][1]) ? $GLOBALS['totals'][1] : '0'; ?></div>
            ...
            <div class="panel panel-green">
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-xs-9 text-right">
                            <div class="huge"><?php echo isset($GLOBALS['totals'][0]) ? $GLOBALS['totals'][0] : '0'; ?></div>
            ...
            <div class="panel panel-yellow">
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-xs-9 text-right">
                            <div class="huge"><?php echo isset($GLOBALS['totals'][2]) ? $GLOBALS['totals'][2] : '0'; ?></div>
                            <div>Total Rooms</div>
                        </div>
                    </div>
                </div>
            ...
            <div class="panel panel-red">
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-xs-9 text-right">
                            <div class="huge"><?php echo isset($GLOBALS['totals'][3]) ? $GLOBALS['totals'][3] : '0'; ?></div>
    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="panel panel-info">
                <div class="panel-heading">
                    <i class="fa fa-list-alt fa-fw"></i>Events Board
                </div>
