...
if (isset($_GET['id']) && isset($_GET['wtd'])) {
    ...
    if ($_GET['wtd'] === "edit") {
        if ($msg === true) {
            ...
            echo '<script type="text/javascript"> alert("Error opening database connection.");</script>';
        }
        ...
        if ($msg === true) {
            ...
            if ($result === true) {
                ...
                echo '<script type="text/javascript"> alert("Error deleting student.");</script>';
            }
        } else {
            echo '<script type="text/javascript"> alert("Error opening database connection.");</script>';
        }
        ...
        if (isset($_POST["btnUpdate"])) {
            ...
            if ($msg === true) {
                ...
                if ($result === true) {
                    ...
                    echo '<script type="text/javascript"> alert("Error updating student.");</script>';
                }
            } else {
                echo '<script type="text/javascript"> alert("Error opening database connection.");</script>';
            }
