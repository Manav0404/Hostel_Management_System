...
if (isset($_GET['id'], $_GET['wtd'])) {
    ...
    if ($_GET['wtd'] === "edit") {
        ...
        if ($msg === true) {
            ...
            if ($result === true) {
                echo '<script type="text/javascript"> alert("Cost Deleted Successfully."); window.location.href = "view.php";</script>';
            } else {
        ...
        if (isset($_POST["btnUpdate"])) {
            ...
            if ($msg === true) {
                ...
                if ($result === true) {
                    ...
                    //  $db->close();
                    echo '<script type="text/javascript"> alert("Cost Updated Successfully."); window.location.href = "view.php";</script>';
