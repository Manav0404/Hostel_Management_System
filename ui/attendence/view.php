...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST["btnUpdate"])) {
        getTableData($_POST['person'], $db, $msg); // Pass $msg as the third argument
        $displaytable = "";
    }
}

if ($loginGrp == "UG004") {
    getTableData($loginId, $db, $msg); // Pass $msg as the third argument
    $display = "none";
    $displaytable = "";
}
...
if ($result !== false && $result !== null) {
    ...
    echo '<script type="text/javascript"> alert("Error occurred while fetching data.");</script>';
}
}
function getTableData($userId, $db, $msg)
{
    if ($msg == "true") {
