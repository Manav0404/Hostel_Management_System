...
if (isset($_GET['id'], $_GET['wtd'])) {
    ...
    if ($_GET['wtd'] === "edit") {
        if ($msg === true) {
            ...
            if ($result !== false && $result !== null) {
                if (mysqli_num_rows($result) > 0) {
                    ...
                    echo '<script type="text/javascript"> alert("No data found."); window.location="view.php";</script>';
                }
            } else {
                echo '<script type="text/javascript"> alert("Error occurred while fetching data."); window.location="view.php";</script>';
            }
        } else {
        ...
        if ($msg === true) {
            ...
            if ($result === true) {
                echo '<script type="text/javascript"> alert("Meal Deleted Successfully."); window.location.href = "view.php";</script>';
            } else {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["btnUpdate"])) {
        ...
        if ($msg === true) {
            ...
            if ($result === true) {
                echo '<script type="text/javascript"> alert("Meal Updated Successfully."); window.location.href = "view.php";</script>';
            } else {
